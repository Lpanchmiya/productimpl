...
public class ProductServiceTest {
    ...
    @Test
    public void testSearchProductNoFilter() {
    	
    	List<ProductDTO> searchProduct = productService.searchProductByStreams(0, 0, null, false);
    ...
    @Test
    public void testSearchProductByPriceFrom() {
    	
    	List<ProductDTO> searchProduct = productService.searchProductByStreams(800, 0, null, false);
    	System.out.println(">>>> " + searchProduct);
    	
    }
    
    @Test
    public void testSearchProductByPriceFromPriceTo() {
    	
    	List<ProductDTO> searchProduct = productService.searchProductByStreams(500, 1000, null, false);
    	System.out.println(">>>> " + searchProduct);
    ...
    public void testSearchProductByCategory() {
    	...
    	List<ProductDTO> searchProduct = productService.searchProductByStreams(0, 0, "Outdoor", false);
    	System.out.println(">>>> " + searchProduct);
    	
    }
    
    @Test
    public void testSearchProductByAvailability() {
    	
    	List<ProductDTO> searchProduct = productService.searchProductByStreams(0, 0, null, true);
    	System.out.println(">>>> " + searchProduct);
